...
public abstract class dmexl {
    ...
    static public <E, F extends IFilterOperation<E>> FilterNode<E, F> filter(Algorithm elements, F f) {
        return filter(elements, I(f));
    }
    
    static public <E, F extends IFilterOperation<E>> FilterNode<E, F> filter(Algorithm elements, Algorithm f) {
